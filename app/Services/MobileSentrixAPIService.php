...
class MobileSentrixAPIService
{
    public function getProducts()
    {
        ...
        $oauthParams = [
            ...
            'oauth_version' => '1.0',
            'limit' => $limit, // Include the limit parameter in OAuth parameters
        ];
        ...
        $fullUrl = $url . '?' . http_build_query(['limit' => $limit]); // Append limit as query parameter
