    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route("mobilesentrix.category.index")); ?>" >
                        <i class="ri-apps-2-line"></i> <span><?php echo app('translator')->get('translation.category'); ?></span>
                    </a>
                </li>
...
<?php /**PATH H:\laragon\www\eccomerce-laravel-mobile-active\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>