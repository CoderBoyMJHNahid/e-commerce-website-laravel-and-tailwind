                            ...
                            <?php if(count($orders) > 0): ?>
                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                switch ($row->product->product_from) {
                                                    case '1':
                                                        echo 'Mobile Active';
                                                        break;
                                                    default:
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\learn_laravel\ecco\resources\views/dashboard/orders/index.blade.php ENDPATH**/ ?>