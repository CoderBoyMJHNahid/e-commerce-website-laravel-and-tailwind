            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="btn_wrapper">
                        ...
                        <a class="btn btn-sm btn btn-primary" href="<?php echo e(route("mobilesentrix")); ?>">Get Product of Mobilesentrix</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <?php if(count($products) > 0): ?>
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo Str::limit($row['description'] , 100); ?></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\laragon\www\eccomerce-laravel-mobile-active\resources\views/dashboard/products/index.blade.php ENDPATH**/ ?>