                ...
                <div class="lg:flex gap-6">
                    <div class="hidden lg:block xl:block px-7 lg:w-6/12  xl:w-3/12">
                        <div class=" relative  border-[1px] border-gray-200 max-sm:border-none">
                            ...
                            <img src="<?php echo e($lastedProduct_active['image']); ?>" alt="" class="w-86 max-sm:w-36 max-sm:mx-auto">

                        </div>
                        <a href="<?php echo e(route('singleProduct', $lastedProduct_active['id'])); ?>"
                            class="text-sm text-[#18a6ef] mt-2 max-sm:text-center"><?php echo e($lastedProduct_active['title']); ?></a>
                        <p class="text-sm text-[#e62337] mt-2">

                            <?php if(auth()->check()): ?>
                                <?php echo e($lastedProduct_active['price']); ?>
                        ...
                        <div class="flex mt-2 items-center  w-[80%]  justify-between gap-4 ">
                            <div class="border-2 border-[#dedede]  rounded-md grid grid-cols-3 ">
                                <button class="decreaseBtn" data-pid="<?php echo e($lastedProduct_active['id']); ?>"
                                    class="border-r-2 text-lg text-[#848484]">-</button>
                                <input type="number" readonly data-pid="<?php echo e($lastedProduct_active['id']); ?>" value="0"
                                    maxlength="12" name="qty"
                                    class="focus:none text-center text-lg text-[#848484] py-[4px] " id="qty_feature_88021">
                                <button class="increaseBtn" data-pid="<?php echo e($lastedProduct_active['id']); ?>"
                                    class="border-l-2 text-lg text-[#848484] increaseBtn">+</button>
                            </div>
                            <?php if(auth()->check()): ?>
                                <form class="cart_form" data-pid="<?php echo e($lastedProduct_active['id']); ?>">
                                    <input type="hidden" class="qty_product<?php echo e($lastedProduct_active['id']); ?>">
                    ...
                    <div class=" lg:w-8/12 xl:w-9/12">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 px-10">
                            <?php $__currentLoopData = $product_active; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="w-full mt-20">
                            <?php echo e($product_active->links()); ?>
                ...
                <div class="lg:flex gap-6">
                    <div class="hidden lg:block xl:block px-7 lg:w-6/12  xl:w-3/12">
                        <div class=" relative  border-[1px] border-gray-200 max-sm:border-none">
                            <img src="<?php echo e(URL::asset('assets/media/png/sub-1.png')); ?>" alt=""
                                class="w-28 max-sm:w-16 absolute top-[-12px] left-[-52px] max-sm:top-[-26px] max-sm:left-[52px]">
                            <img src="<?php echo e($lastedProduct_strix['image']); ?>" alt="" class="w-86 max-sm:w-36 max-sm:mx-auto">

                        </div>
                        <a href="<?php echo e(route('singleProduct', $lastedProduct_strix['id'])); ?>"
                            class="text-sm text-[#18a6ef] mt-2 max-sm:text-center"><?php echo e($lastedProduct_strix['title']); ?></a>
                        <p class="text-sm text-[#e62337] mt-2">

                            <?php if(auth()->check()): ?>
                                <?php echo e($lastedProduct_strix['price']); ?>
                        ...
                        <div class="flex mt-2 items-center  w-[80%]  justify-between gap-4 ">
                            <div class="border-2 border-[#dedede]  rounded-md grid grid-cols-3 ">
                                <button class="decreaseBtn" data-pid="<?php echo e($lastedProduct_strix['id']); ?>"
                                    class="border-r-2 text-lg text-[#848484]">-</button>
                                <input type="number" readonly data-pid="<?php echo e($lastedProduct_strix['id']); ?>" value="0"
                                    maxlength="12" name="qty"
                                    class="focus:none text-center text-lg text-[#848484] py-[4px] " id="qty_feature_88021">
                                <button class="increaseBtn" data-pid="<?php echo e($lastedProduct_strix['id']); ?>"
                                    class="border-l-2 text-lg text-[#848484] increaseBtn">+</button>
                            </div>
                            <?php if(auth()->check()): ?>
                                <form class="cart_form" data-pid="<?php echo e($lastedProduct_strix['id']); ?>">
                                    <input type="hidden" class="qty_product<?php echo e($lastedProduct_strix['id']); ?>">
                                    <button class="cart_btn" type="submit">
                                        <img src="assets/media/svg/cart-check-svgrepo-com.svg" alt=""
                                            class="hover:bg-[#ff0004] rounded-md bg-black  cursor-pointer transition-all duration-300 p-2 w-[145px]">
                                    </button>
                    ...
                    <div class=" lg:w-8/12 xl:w-9/12">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 px-10">
                            <?php $__currentLoopData = $product_strix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="grid grid-cols-4 gap-4 ">
                                    <div class=" relative  border-[1px] border-gray-200 col-span-1 h-fit">
                                        <img src="assets/media/png/AFTERMARKET.png" alt=""
                                            class="w-12  absolute top-[-12px] left-[-16px]">
                        ...
                        <div class="w-full mt-20">
                            <?php echo e($product_strix->links()); ?>
...
<?php echo $__env->make('home.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\learn_laravel\complete\e-commaerce\resources\views/home/index.blade.php ENDPATH**/ ?>