                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-20 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                    data-target="{{$productCount}}">0</span></h4>
                            <a href="{{route("products.index")}}" class="text-decoration-underline">View Products </a>
                        </div>
                    </div>
                </div><!-- end card body -->
            </div><!-- end card -->
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-20 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                    data-target="{{$orderCount}}">0</span></h4>
                            <a href="{{route("order.index")}}" class="text-decoration-underline">View all orders</a>
                        </div>
