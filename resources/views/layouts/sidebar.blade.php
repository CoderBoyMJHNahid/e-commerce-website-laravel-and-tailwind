    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route("mobilesentrix.category.index") }}" >
                        <i class="ri-apps-2-line"></i> <span>@lang('translation.category')</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route("products.index") }}" >
                        <i class="ri-apps-2-line"></i> <span>@lang('translation.products')</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route("orders.index") }}">
                        <i class="ri-stack-line"></i> <span>@lang('translation.orders')</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('settings') }}">
                        <i class="ri-share-line"></i> <span>@lang('translation.settings')</span>
                    </a>
                </li>
