...
<section class="max-sm:hidden">
    <!-- top header -->
    <div class="grid grid-cols-8 mx-auto container items-center py-4 grid-cols-12 gap-2">
        <div class="col-span-2">
            <a href="{{ route('home') }}">
                <svg width="147" height="35" viewBox="0 0 147 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                        d="M75.5806 15.7544C75.5806 15.7544 76.1951 14.9276 76.8431 14.4863C77.5415 14.0114 78.2733 13.9165 78.2733 13.9165V0.866211H75.7202L75.5806 15.7544Z"
                        fill="#11100A" />
                    <path
                        d="M83.4336 4.20703C80.6068 4.20703 78.6851 6.36345 78.6851 9.19584C78.6851 12.1232 80.5007 14.1679 83.4336 14.1679C85.5398 14.1679 87.0649 13.2182 87.7856 10.9891H85.5398C85.3778 11.5757 84.551 12.2126 83.523 12.2126C82.104 12.2126 81.3107 11.464 81.2381 9.81596H87.9476C88.132 6.91652 86.6012 4.20703 83.4336 4.20703ZM81.2437 8.1735C81.2772 7.44166 81.7465 6.16233 83.3666 6.16233C84.6068 6.16233 85.1655 6.85507 85.4001 8.1735H81.2437Z"
                        fill="#11100A" />
                    <path
                        d="M35.3115 28.692C35.5182 33.3735 39.5015 34.9098 43.5908 34.9098C47.6132 34.9098 51.6299 33.407 51.6299 28.759C51.6299 25.4797 48.8701 24.4518 46.0433 23.8037C43.2836 23.1557 40.5573 22.9154 40.5573 21.1724C40.5573 19.7367 42.1607 19.53 43.25 19.53C44.9875 19.53 46.4176 20.0439 46.5573 21.921H51.1551C50.7808 17.5803 47.2389 16.2842 43.3841 16.2842C39.602 16.2842 35.7193 17.4462 35.7193 21.9546C35.7193 25.0663 38.5126 26.0551 41.3059 26.6696C44.7808 27.4238 46.7919 27.9322 46.7919 29.4015C46.7919 31.111 45.021 31.6584 43.6243 31.6584C41.7137 31.6584 39.9428 30.8037 39.9093 28.6864H35.3115V28.692Z"
                        fill="#F10600" />
                    <path
                        d="M69.4503 26.7758C69.7911 21.34 66.8972 16.2842 60.8972 16.2842C55.5453 16.2842 51.9028 20.3177 51.9028 25.6138C51.9028 31.083 55.3442 34.9098 60.8972 34.9098C64.886 34.9098 67.7799 33.1333 69.143 28.9657H64.886C64.5788 30.0607 63.0145 31.2562 61.0704 31.2562C58.3777 31.2562 56.8805 29.854 56.7408 26.7814H69.4503V26.7758ZM56.7408 23.7032C56.8078 22.3344 57.6961 19.9434 60.7631 19.9434C63.1151 19.9434 64.171 21.2395 64.6123 23.7032H56.7408Z"
                        fill="#F10600" />
                    <path
                        d="M70.6138 34.4294H75.4517V25.1724C75.4517 21.5858 76.5746 20.1166 79.2003 20.1166C81.4517 20.1166 82.3009 21.5523 82.3009 24.4573V34.435H87.1389V23.5635C87.1389 19.1892 85.8428 16.2842 80.6975 16.2842C78.6529 16.2842 76.5411 17.2395 75.3121 19.2227H75.2115V16.7646H70.6138V34.4294Z"
                        fill="#F10600" />
                    <path
                        d="M95.2497 11.4688H90.4118V16.7648L85.2051 16.4743C85.6576 16.2788 88.0319 19.776 87.4844 20.0106H90.4174V30.4352C90.4174 33.9547 93.0095 34.6363 95.9704 34.6363C96.9257 34.6363 97.9816 34.6028 98.7972 34.4631V30.6698C98.2888 30.7704 97.8084 30.8039 97.3 30.8039C95.6631 30.8039 95.2553 30.3961 95.2553 28.7536V20.0106H98.6855V16.7648H95.2553V11.4688H95.2497Z"
                        fill="#F10600" />
                    <path
                        d="M99.4062 34.4294H104.244V26.4685C104.244 23.3568 105.473 20.7982 109.015 20.7982C109.596 20.7982 109.68 20.8652 110.127 20.9713V16.9546C109.82 16.854 110.038 16.7814 109.697 16.7814C107.345 16.7814 104.959 18.3177 104.077 20.5412H104.01V16.7646H99.4118V34.4294H99.4062Z"
                        fill="#F10600" />
                    <path d="M111.093 34.4294H115.931L115.697 18.3401L111.093 16.7646V34.4294Z" fill="#F10600" />
                    <path
                        d="M127.914 24.9099L125.272 21.2283L122.283 16.7646H117.037L122.423 25.0104L116.043 34.368H121.501L125.205 28.759L128.909 34.368H134.467L127.914 24.9099Z"
                        fill="#F10600" />
        ...
        <!-- serach field -->
        <div class="relative border rounded-full flex justify-center items-center col-span-3">
            <!-- Search Icon -->
            <div
                class="absolute inset-y-0 right-0 bg-red-600  rounded-full flex items-center pointer-events-none justify-center h-[40px] w-[40px]">
            ...
            <!-- Input Field -->
            <form class="w-full border-0" action="{{route("search")}}" method="GET">
                <input
        ...
        {{-- <div class="col-span-2 bg-[#f3f3f3] p-2 rounded-lg">
            ...
            <div class="flex items-center justify-center  gap-2">
                <p class="text-[10px]"><b>FedEx</b> standard <br> overnight</p>
                <button class="text-[9px] bg-white rounded-full py-[4px] px-2 font-medium shadow-xl">More
                    details</button>
            </div>
        ...
        <div data-modal-target="cart-modal" data-modal-toggle="cart-modal" class="flex bg-[#dedede] col-span-2 rounded-md p-3 gap-8 hover:cursor-pointer">
            ...
            <div>
                ...
                <p id="cart_amount" class="text-[16px] font-medium text-gray-700">$0.00</p>
            </div>
        </div>
    </div>

    <!-- main header -->
    <div class="custom-shadow  py-2">
        <div class="container mx-auto">
            <ul class="flex justify-between  w-full">
                {{-- <li><a href="#" class="text-[13px] text-gray-700">Apple</a></li>
                <li><a href="#" class="text-[13px] text-gray-700">Samsung</a></li>
                <li><a href="#" class="text-[13px] text-gray-700">Motorola</a></li>
                <li><a href="#" class="text-[13px] text-gray-700">LG</a></li>
                <li><a href="#" class="text-[13px] text-gray-700">Other Parts</a></li>
                <li><a href="#" class="text-[13px] text-gray-700">Game Console</a></li>
                <li class="relative"><span
                        class="absolute top-[-25px] right-0 text-[11px] bg-[#e3051b] text-white font-medium px-[2px] ">NEW</span>
                    <a href="#" class="text-[13px] text-gray-700 ">Accessories</a>
                </li>
                <li><a href="#" class="text-[13px] text-gray-700">Tools & Supplies</a></li>
                <li><a href="#" class="text-[13px] text-gray-700">Refurbishing</a></li>
                <li><a href="#" class="text-[13px] text-gray-700">Board Components</a></li>
                <li><a href="#" class="text-[13px] text-gray-700">Pre-Owned Devices</a></li> --}}
                @foreach($categories as $category)
                <li><a href="{{ route('category.product',$category->entity_id) }}" class="text-[13px] text-gray-700">{{ $category->category }}</a></li>
                @endforeach
            </ul>
        </div>
